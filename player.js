...
import { Diving } from './playerStates.js';
import { Hit } from './playerStates.js';
import { CollisionAnimation } from './collisionAnimation.js';
import { FloatinngMessage } from './floatingMessages.js';
        ...
        this.game.enemies.forEach( enemy => {
            if(
                ...
                if(this.currentState === this.states[4] || this.currentState === this.states[5]){
                    this.game.score++;
                    this.game.floatingMessages.push(new FloatinngMessage('+1', enemy.x, enemy.y, 150, 50));
                } else {
                    this.setState(6, 0);
                    this.game.lives--;
