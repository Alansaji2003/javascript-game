    ...
    draw(context){
        ...
        if (this.game.gameOver){
            ...
            if(this.game.score > 40){
                ...
                context.fillText('nah that was weak XD', this.game.width * 0.5, this.game.height * 0.5 - 20);
                context.font = this.fontSize - 6 + 'px ' + this.fontFamily;
                context.fillText('Try again boi', this.game.width * 0.5, this.game.height * 0.5 + 20);
            }
        }
        context.restore();
    }
